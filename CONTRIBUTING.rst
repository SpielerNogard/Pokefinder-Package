...
Welcome to ``Pokefinder`` contributor's guide.
...
If you experience bugs or general issues with ``Pokefinder``, please have a look
...
You can help improve ``Pokefinder`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``Pokefinder`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``Pokefinder``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n Pokefinder python=3 six virtualenv pytest pytest-cov
    conda activate Pokefinder
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/Pokefinder.git
    cd Pokefinder
...
#. Install |pre-commit|_::
   ...
   ``Pokefinder`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/Pokefinder
.. _issue tracker: https://github.com/<USERNAME>/Pokefinder/issues
.. <-- end -->
